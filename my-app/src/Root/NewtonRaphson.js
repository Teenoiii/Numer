        ...
        <Container>
            ...
            <Form>
                <Form.Group className="mb-3">
                    ...
                    <Form.Label>Input f'(x)</Form.Label>
                    <input type="text" value={Derivative} onChange={inputDerivative} style={{ width: "20%", margin: "0 auto" }} className="form-control" />
